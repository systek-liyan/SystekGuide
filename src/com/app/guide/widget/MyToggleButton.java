...
/**
 * 自定义样式ToggleButton，由两个RadioButton组成，分别作为开/关按钮(由一个RadioGroup管理)
 * Created by Yetwish on 2015/8/1.
 */
public class MyToggleButton extends LinearLayout{
    ...
    public void setCurrentState(int state){
    	...
    	mState = state;
    	if(mState == STATE_ON) btnOn.setChecked(true);
    ...
    public MyToggleButton(Context context){
        super(context);
        LayoutInflater.from(context).inflate(R.layout.custom_toggle_btn, this, true);
