package com.yetwish.tourismguide.adapter;
...
public class GridAdapter extends BaseAdapter{
	...
	public View getView(int position, View converView, ViewGroup root) {
		Button btnItem;
		if(converView == null){
			converView = LayoutInflater.from(mContext).inflate(R.layout.fragment_subject_seletor_grid_item, root,false);
			btnItem = (Button) converView.findViewById(R.id.fragment_subject_selector_grid_item_btn);
